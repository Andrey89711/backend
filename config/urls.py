...
urlpatterns = [
    ...
    path('api/finance/', include('finance.api.v1.urls')),
    path('api/notifications/', include('notifications.api.v1.urls')),
    path('api/admin-panel/', include('admin_panel.api.v1.urls')),
