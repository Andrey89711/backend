        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_accountant",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID бухгалтера"
                    ),
                ),
                (
                    "full_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_contract",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID договора"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_director",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID директора"
                    ),
                ),
                (
                    "full_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_manager",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID менеджера"
                    ),
                ),
                (
                    "full_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_materials",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID материала"
                    ),
                ),
                (
                    "name",
                    models.CharField(max_length=300, verbose_name="Название материала"),
                ),
                (
                    "unit_of_measurement",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_storekeeper",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID кладовщика"
                    ),
                ),
                (
                    "full_name",
                    models.CharField(max_length=180, verbose_name="Полное имя"),
                ),
                (
                    "contact_information",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_supplier",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID поставщика"
                    ),
                ),
                (
                    "name",
                ...
                (
                    "tax_id",
                    models.CharField(
                        max_length=200, verbose_name="ИНН/Налоговый номер"
                    ),
                ),
                (
                    "accounted_full_name",
                    models.CharField(max_length=200, verbose_name="ФИО бухгалтера"),
                ),
                (
                    "director_full_name",
                    models.CharField(max_length=200, verbose_name="ФИО директора"),
                ),
                (
                    "payment_details",
                    models.CharField(
                        max_length=500, verbose_name="Платежные реквизиты"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_warehouse",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID склада"
                    ),
                ),
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Название склада"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_delivery",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID поставки"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_prices",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="ID цены"
                    ),
                ),
                (
                    "effective_dates",
                    models.DateField(verbose_name="Дата начала действия"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(verbose_name="Качество материалов в договоре"),
                ),
                (
                    "condition",
                    models.CharField(max_length=200, verbose_name="Состояние/условие"),
                ),
                (
                    "actual_quantity",
                    models.FloatField(verbose_name="Фактическое количество"),
                ),
                (
                    "id_contract",
                    models.ForeignKey(
